              ...
              >
                <span
                  className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl text-2xl ${
                    isHighlighted ? 'bg-white/15' : 'bg-slate-50'
                  }`}
                >
                  {m.emoji}
                </span>
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    <h2
                      className={`text-base font-black ${isHighlighted ? 'text-white' : 'text-slate-900'}`}
                    >
                      {m.title}
                    </h2>
                    {isHighlighted && (
                ...
                <span
                  className={`mt-1 shrink-0 text-lg font-black ${
                    isHighlighted ? 'text-white/70' : 'text-slate-300 group-hover:text-indigo-400'
                  }`}
                >
                  →
                </span>
