...
export const VSTEP_FULL_SPEAKING_EXAMS: VstepFullSpeakingExam[] = [
  ...
  },
  {
    ...
    targetLevel: 'C1',
    totalDurationMinutes: 12,
    part1: VSTEP_SPEAKING_PART1_TOPICS[9], // Transportation & Commuting
  ...
  },
  {
    ...
    title: 'VSTEP Speaking Mock Exam 5: Global Communication & Enterprise Growth',
    titleVi: 'Đề thi thử VSTEP Nói 5: Giao tiếp toàn cầu & Tăng trưởng doanh nghiệp',
    ...
    part3: VSTEP_SPEAKING_PART3_TOPICS[2], // Remote work
  },
];
