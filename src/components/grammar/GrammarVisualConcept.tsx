...
export default function GrammarVisualConcept({ buoiNum, lessonTitle }: GrammarVisualConceptProps) {
  ...
  if (buoiNum === 6 || /hỏi đuôi|tag question/i.test(lessonTitle)) {
    return (
      <div className="my-5 p-5 sm:p-6 rounded-2xl bg-card border border-border shadow-xs space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-foreground font-bold text-sm sm:text-base">
            <ArrowLeftRight className="h-4 w-4 text-primary" />
            <span>Quy tắc đảo dấu câu hỏi đuôi (Tag Questions)</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="p-4 bg-muted/30 rounded-xl border border-border/70 space-y-2.5">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-semibold uppercase px-2 py-0.5 rounded bg-emerald-100 text-emerald-800 dark:bg-emerald-950/60 dark:text-emerald-300">
                Khẳng định (+) ➔ Phủ định (−)
              </span>
            </div>
            <div className="flex items-center justify-between text-xs sm:text-sm font-semibold text-foreground p-2.5 rounded-lg bg-background border border-border/60">
          ...
          <div className="p-4 bg-muted/30 rounded-xl border border-border/70 space-y-2.5">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-semibold uppercase px-2 py-0.5 rounded bg-rose-100 text-rose-800 dark:bg-rose-950/60 dark:text-rose-300">
                Phủ định (−) ➔ Khẳng định (+)
              </span>
            </div>
            <div className="flex items-center justify-between text-xs sm:text-sm font-semibold text-foreground p-2.5 rounded-lg bg-background border border-border/60">
        ...
        <div className="p-3.5 bg-amber-500/10 rounded-xl border border-amber-500/20 text-xs space-y-1.5">
      ...
      <div className="my-5 p-5 sm:p-6 rounded-2xl bg-card border border-border shadow-xs space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-foreground font-bold text-sm sm:text-base">
            ...
            <span>Sơ đồ chuyển đổi Chủ động ➔ Bị động (Active to Passive)</span>
          </div>
          <span className="text-[11px] font-semibold text-primary bg-primary/10 px-2.5 py-0.5 rounded-md">
            Công thức gốc: be + V3/ed
          </span>
        </div>

        <div className="p-4 bg-muted/30 rounded-xl border border-border/70 space-y-3.5">
          {/* Visual Transformation */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="p-3.5 rounded-lg bg-background border border-border/60">
              <span className="text-[10px] font-semibold uppercase text-sky-700 dark:text-sky-300 bg-sky-50 dark:bg-sky-950/60 px-2 py-0.5 rounded">
                Chủ Động (Active)
              </span>
            ...
            <div className="p-3.5 rounded-lg bg-background border border-border/60">
              <span className="text-[10px] font-semibold uppercase text-indigo-700 dark:text-indigo-300 bg-indigo-50 dark:bg-indigo-950/60 px-2 py-0.5 rounded">
                Bị Động (Passive)
              </span>
              <p className="mt-2 text-sm font-semibold text-foreground flex items-center justify-between">
                <span>
          ...
          <div className="p-3 rounded-lg bg-background border border-border/60 text-xs font-mono grid grid-cols-2 sm:grid-cols-4 gap-2 text-foreground">
      ...
      <div className="my-5 p-5 sm:p-6 rounded-2xl bg-card border border-border shadow-xs space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-foreground font-bold text-sm sm:text-base">
            ...
            <span>Trật tự tính từ đứng trước danh từ (OSASCOMP)</span>
          </div>
          <span className="text-[11px] font-semibold text-primary bg-primary/10 px-2.5 py-0.5 rounded-md">
            Thần chú OSASCOMP
          </span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-2">
          {osascompItems.map((item, idx) => (
            <div
              key={idx}
              className="p-2.5 bg-muted/30 rounded-xl border border-border/70 flex flex-col items-center text-center"
            >
        ...
        {/* Ví dụ mẫu phát âm */}
        <div className="p-3 bg-muted/30 rounded-xl border border-border/70 flex items-center justify-between gap-3 text-xs sm:text-sm">
          <div>
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-background hover:bg-muted border border-border text-foreground transition-colors"
            title="Nghe"
          >
            <Volume2 className="h-4 w-4" />
          </button>
      ...
      <div className="my-5 p-5 sm:p-6 rounded-2xl bg-card border border-border shadow-xs space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-foreground font-bold text-sm sm:text-base">
            ...
            <span>Các dạng so sánh tính từ & trạng từ (Comparison Scale)</span>
          </div>
          <span className="text-[11px] font-semibold text-primary bg-primary/10 px-2.5 py-0.5 rounded-md">
            Bằng · Hơn · Nhất · Kép
          </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="p-3.5 bg-muted/30 rounded-xl border border-border/70">
      ...
      <div className="my-5 p-5 sm:p-6 rounded-2xl bg-card border border-border shadow-xs space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-foreground font-bold text-sm sm:text-base">
            ...
            <span>Hệ thống câu điều kiện (Conditionals Tree)</span>
          </div>
          <span className="text-[11px] font-semibold text-primary bg-primary/10 px-2.5 py-0.5 rounded-md">
            Loại 1, 2, 3 & Đảo ngữ
          </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="p-3.5 bg-muted/30 rounded-xl border-l-3 border-emerald-500 border-t border-r border-b border-border/70">
          ...
          <div className="p-3.5 bg-muted/30 rounded-xl border-l-3 border-sky-500 border-t border-r border-b border-border/70">
          ...
          <div className="p-3.5 bg-muted/30 rounded-xl border-l-3 border-purple-500 border-t border-r border-b border-border/70">
      ...
      <div className="my-5 p-5 sm:p-6 rounded-2xl bg-card border border-border shadow-xs space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-foreground font-bold text-sm sm:text-base">
            ...
            <span>Quy tắc chọn đại từ quan hệ (Relative Pronouns)</span>
          </div>
          <span className="text-[11px] font-semibold text-primary bg-primary/10 px-2.5 py-0.5 rounded-md">
            Người vs Vật
          </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-2.5 text-xs">
          <div className="p-3 bg-muted/30 rounded-xl border border-border/70 text-center">
      ...
      <div className="my-5 p-5 sm:p-6 rounded-2xl bg-card border border-border shadow-xs space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-foreground font-bold text-sm sm:text-base">
            ...
            <span>Quy tắc chọn mạo từ: A / An / The / Ø</span>
          </div>
          <span className="text-[11px] font-semibold text-primary bg-primary/10 px-2.5 py-0.5 rounded-md">
            Đếm được & Xác định
          </span>
      ...
      <div className="my-5 p-5 sm:p-6 rounded-2xl bg-card border border-border shadow-xs space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-foreground font-bold text-sm sm:text-base">
            ...
            <span>Mô hình giới từ In – On – At (Thời gian & Địa điểm)</span>
          </div>
          <span className="text-[11px] font-semibold text-primary bg-primary/10 px-2.5 py-0.5 rounded-md">
            Phạm vi: Rộng ➔ Hẹp
          </span>
        ...
        <div className="space-y-2">
          <div className="p-3 rounded-xl bg-sky-50 dark:bg-sky-950/50 border border-sky-200 dark:border-sky-800 text-xs font-medium text-sky-900 dark:text-sky-200 text-center">
            <span className="font-bold">IN (Rộng nhất)</span> · Năm (in 2026), Tháng (in May), Mùa (in summer), Quốc gia (in Vietnam), Thành phố (in Hanoi)
          </div>
          <div className="p-3 rounded-xl bg-indigo-50 dark:bg-indigo-950/50 border border-indigo-200 dark:border-indigo-800 text-xs font-medium text-indigo-900 dark:text-indigo-200 text-center mx-3 sm:mx-6">
            <span className="font-bold">ON (Vừa phải)</span> · Thứ (on Monday), Ngày cụ thể (on May 5th), Con đường (on Tran Phu Street)
          </div>
          <div className="p-3 rounded-xl bg-violet-50 dark:bg-violet-950/50 border border-violet-200 dark:border-violet-800 text-xs font-medium text-violet-900 dark:text-violet-200 text-center mx-6 sm:mx-12">
      ...
      <div className="my-5 p-5 sm:p-6 rounded-2xl bg-card border border-border shadow-xs space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-foreground font-bold text-sm sm:text-base">
            ...
            <span>Quy tắc phát âm đuôi -s/es & -ed</span>
          </div>
          <span className="text-[11px] font-semibold text-primary bg-primary/10 px-2.5 py-0.5 rounded-md">
            Kèm audio phát âm
          </span>
        ...
        <div className="p-4 bg-muted/30 rounded-xl border border-border/70 space-y-2.5">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] text-muted-foreground">Mẹo nhớ nhanh</span>
          </div>
  ...
  return (
    <div className="my-5 p-5 sm:p-6 rounded-2xl bg-card border border-border shadow-xs space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 text-foreground font-bold text-sm sm:text-base">
          <Compass className="h-4 w-4 text-primary" />
          <span>Trọng tâm kiến thức: Buổi {buoiNum} · {lessonTitle}</span>
        </div>
        <span className="text-[11px] font-semibold text-primary bg-primary/10 px-2.5 py-0.5 rounded-md">
          Ngữ pháp ứng dụng
        </span>
