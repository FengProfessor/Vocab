    ...
    <div className="w-full space-y-6">
      <div className="text-center space-y-2 max-w-2xl mx-auto">
        ...
        <h2 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">
          Ma Trận 15 Chiều Không Gian Sát Thủ
        </h2>
        <p className="text-xs sm:text-sm text-slate-400">
          Giải mã toàn bộ các cấu trúc bẫy âm học, ngữ nghĩa và tâm lý được cài cắm trong 2,000 câu hỏi ETS 2024 &amp; ETS 2026.
        </p>
      </div>
      ...
      <div className="flex justify-center">
        <div className="inline-flex p-1.5 rounded-2xl bg-slate-900 border border-slate-800 gap-1 overflow-x-auto max-w-full">
          ...
          >
            ...
            <span className="text-[10px] px-1.5 py-0.5 rounded-md bg-black/20 font-mono">
              6 Câu
            </span>
          </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
        ...
        <div className="lg:col-span-7 rounded-3xl bg-slate-900/90 border border-slate-800 p-5 sm:p-7 shadow-2xl backdrop-blur-md space-y-5">
          {/* Header */}
          <div className="border-b border-slate-800 pb-4 space-y-2">
            <div className="flex flex-wrap items-center justify-between gap-2">
              <span className="px-2.5 py-1 rounded-lg bg-indigo-500/10 border border-indigo-500/30 text-indigo-400 font-mono text-xs font-bold">
                CHIỀU {selectedDimension.id} / 15
              </span>
              <span className="text-xs text-emerald-400 font-mono font-semibold bg-emerald-500/10 px-2.5 py-0.5 rounded-full border border-emerald-500/30">
            ...
            <p className="text-xs text-slate-400 font-mono">
              Ký hiệu học thuật: {selectedDimension.codeName}
            </p>
          </div>
          ...
          <div className="space-y-2">
            <h4 className="text-xs font-bold uppercase tracking-wider text-rose-400 flex items-center gap-1.5">
              ...
              Bản chất bẫy tử huyệt của ETS:
            </h4>
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed bg-slate-950 p-3.5 rounded-xl border border-slate-800/80">
          ...
          <div className="space-y-2">
            ...
            <div className="p-3.5 rounded-xl bg-sky-950/30 border border-sky-500/30 text-sky-200 text-xs sm:text-sm font-mono leading-relaxed">
              {selectedDimension.examProof}
            </div>
          </div>

          {/* 3-Second Reflex Formula */}
          <div className="p-4 rounded-2xl bg-gradient-to-r from-indigo-950/60 via-purple-950/40 to-slate-950 border border-indigo-500/30 space-y-1.5">
