    ...
    <div className="w-full space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 rounded-xl bg-white border border-slate-200 text-slate-900 placeholder:text-slate-400 text-xs sm:text-sm shadow-xs focus:outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600 transition"
          />
        </div>
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto w-full sm:w-auto pb-1 sm:pb-0 text-xs">
          <button
            ...
            className={`px-3.5 py-2 rounded-xl transition whitespace-nowrap font-medium cursor-pointer ${
              activeGroupIndex === 0
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {visibleItems.map((item: DictItem) => (
          <div
            key={item.id}
            className="p-4 rounded-2xl bg-white border border-slate-200/90 hover:border-indigo-300 hover:shadow-lg transition-all duration-200 shadow-sm flex flex-col justify-between space-y-3"
          >
            {/* Top row */}
              ...
              <div className="flex items-start justify-between gap-2">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-bold text-base text-slate-900 hover:text-indigo-600 transition flex items-center gap-1.5">
                      {item.word}
                    </h3>
                  </div>
                  <span className="text-xs font-mono text-indigo-600 font-semibold block mt-0.5">
                    {item.ipa}
                  </span>
                </div>
                ...
                <button
                  ...
                  className="p-2 rounded-xl bg-slate-100 text-slate-600 hover:text-white hover:bg-indigo-600 border border-slate-200 transition flex-shrink-0 cursor-pointer"
                >
            ...
            <div className="space-y-2 pt-2 border-t border-slate-100 text-xs">
              ...
              {/* Trap warning */}
              <div className="p-2.5 rounded-xl bg-amber-50/70 border border-amber-200 text-amber-950 space-y-1 text-[11px]">
                ...
                <p className="leading-snug text-amber-900/90">{item.trap}</p>
              </div>
            </div>
            ...
            <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-[11px]">
              ...
              <span className="font-mono font-bold text-sky-700 bg-sky-50 px-2 py-0.5 rounded-full border border-sky-200 flex-shrink-0 text-[10px]">
                {item.citation}
              </span>
            </div>
          </div>
      ...
      {displayCount < filteredWords.length && (
        <div className="text-center pt-2">
          <button
            ...
            className="px-6 py-2.5 rounded-xl bg-white hover:bg-slate-50 text-slate-800 text-xs sm:text-sm font-semibold border border-slate-200 shadow-sm hover:border-slate-300 transition inline-flex items-center gap-2 cursor-pointer"
          >
