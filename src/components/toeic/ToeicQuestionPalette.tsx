...
export function ToeicQuestionPalette({
  ...
  return (
    <>
      {/* Floating Toggle Button when Palette is collapsed */}
      {!isOpen && (
        <button
          type="button"
          onClick={onToggleOpen}
          className="fixed right-4 bottom-20 z-40 flex h-10 items-center gap-2 rounded-sm border border-slate-700 bg-slate-900 px-3 font-mono text-xs font-bold text-white shadow-none transition-colors hover:bg-slate-800 dark:border-slate-300 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-white sm:bottom-6 cursor-pointer"
