...
// Thứ tự + cấp theo NLM English Grammar Profile (docs/roadmap-research/02-grammar-level-map.md).
// Map 5 cấp lộ trình → 3 bậc DB: A0+A1+A2 = beginner · B1 = intermediate · B2 = advanced.
const PLACEMENTS: Placement[] = [
  ...
  // B1
  { slug: 'present-perfect', level: 'intermediate' },
  ...
  { slug: 'question-tags', level: 'intermediate' },
  { slug: 'phrasal-verbs', level: 'intermediate' },
  // B2
  { slug: 'past-perfect-continuous', level: 'advanced' },
  { slug: 'future-perfect', level: 'advanced' },
  { slug: 'future-in-the-past', level: 'advanced' },
  { slug: 'mixed-conditionals', level: 'advanced' },
  { slug: 'wish-if-only', level: 'advanced' },
  { slug: 'modals-perfect', level: 'advanced' },
  { slug: 'causative', level: 'advanced' },
  { slug: 'advanced-passive', level: 'advanced' },
  { slug: 'advanced-relative-clauses', level: 'advanced' },
